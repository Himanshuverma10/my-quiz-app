...
module.exports = async (req, res) => {
    ...
    const prompt = `Analyze syllabus: """${syllabusText.substring(0, 15000)}""". Return JSON array: [{"unit": "Unit 1", "topics": ["A", "B"]}]. No markdown.`;
    ...
    try {
        ...
        res.status(200).json({ syllabusData, usage });
